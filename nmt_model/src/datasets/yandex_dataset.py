...
class YandexDataset(BaseDataset):
    ...
    def __init__(self, src_lang: str, trg_lang: str, datapath: str, tokenizer, split: str, limit: Optional[int] = None):
        ...
        super(YandexDataset, self).__init__(examples, tokenizer, split, limit)
